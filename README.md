...
```
wget https://github.com/DonczewLab/ChEC-Seq_Analysis/releases/download/v2.0.0/ChEC-Seq_Analysis-2.0.0.tar.gz
tar -xzf ChEC-Seq_Analysis-2.0.0.tar.gz
rm ChEC-Seq_Analysis-2.0.0.tar.gz
cd ChEC-Seq_Analysis-2.0.0
```
9B. Load modules
```
module purge
...
**Boyd, K.A.**, Ridenour, J.B., & Donczew, R. (2025). *ChEC-Seq_Analysis: A reproducible Snakemake workflow for Chromatin Endogenous Cleavage (ChEC) experiments*. Zenodo. https://doi.org/10.5281/zenodo.15232549
